...
namespace InternetClients.greetBackendCanister.Models
{
	...
	public class Result8
	{
		...
		public static Result8 Ok((Principal, string, UnboundedUInt, string, string, string, OptionalValue<string>) info)
		{
		...
		public (Principal, string, UnboundedUInt, string, string, string, OptionalValue<string>) AsOk()
		{
			this.ValidateTag(Result8Tag.Ok);
			return ((Principal, string, UnboundedUInt, string, string, string, OptionalValue<string>))this.Value!;
		}
